...
func (suite *DayStepsTestSuite) TestDayActionInfo() {
	...
	tests := []struct {
	...
	}{
		{
			...
			weight: 75.0,
			height: 1.75,
			// Расчет: шаги=6000, рост=1.75, коэффициент=0.45
			// Дистанция = 6000 * (1.75 * 0.45) / 1000 = 6000 * 0.7875 / 1000 = 4.725 км ≈ 4.72 км
			// Калории рассчитываются в spentcalories с walkingCaloriesCoefficient = 0.5
			want:          "Количество шагов: 6000.\nДистанция составила 4.72 км.\nВы сожгли 145.69 ккал.",
			wantLogOutput: false,
		},
		{
			...
			weight: 75.0,
			height: 1.75,
			// Дистанция = 3000 * (1.75 * 0.45) / 1000 = 3000 * 0.7875 / 1000 = 2.3625 км ≈ 2.36 км
			want:          "Количество шагов: 3000.\nДистанция составила 2.36 км.\nВы сожгли 72.84 ккал.",
			wantLogOutput: false,
		},
		{
			...
			weight: 75.0,
			height: 1.75,
			// Дистанция = 20000 * (1.75 * 0.45) / 1000 = 20000 * 0.7875 / 1000 = 15.75 км
			want:          "Количество шагов: 20000.\nДистанция составила 15.75 км.\nВы сожгли 485.62 ккал.",
			wantLogOutput: false,
		},
		{
			...
			weight: 75.0,
			height: 1.75,
			// Дистанция = 1000 * (1.75 * 0.45) / 1000 = 1000 * 0.7875 / 1000 = 0.7875 км ≈ 0.79 км
			want:          "Количество шагов: 1000.\nДистанция составила 0.79 км.\nВы сожгли 24.28 ккал.",
			wantLogOutput: false,
		},
		{
			...
			weight: 60.0,
			height: 1.85,
			// Дистанция = 6000 * (1.85 * 0.45) / 1000 = 6000 * 0.8325 / 1000 = 4.995 км ≈ 5.00 км
			want:          "Количество шагов: 6000.\nДистанция составила 5.00 км.\nВы сожгли 123.21 ккал.",
			wantLogOutput: false,
		},
		{
